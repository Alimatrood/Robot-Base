...
if (isset($_POST['turned'])) {
  ...
  $sql = 'INSERT INTO base (Moving) VALUES ("F")';
  if ($conn->query($sql) === TRUE) {
    echo "<br>Executed Successfully";
  } else {
    echo "Error: " . $last . "<br>" . $conn->error;
  ...
  $sql = 'INSERT INTO base (Moving) VALUES ("B")';
  if ($conn->query($sql) === TRUE) {
    echo "<br>Executed Successfully";
  } else {
    echo "Error: " . $last . "<br>" . $conn->error;
  ...
  $sql = 'INSERT INTO base (Moving) VALUES ("R")';
  if ($conn->query($sql) === TRUE) {
    echo "<br>Executed Successfully";
  } else {
    echo "Error: " . $last . "<br>" . $conn->error;
  ...
  $sql = 'INSERT INTO base (Moving) VALUES ("L")';
  if ($conn->query($sql) === TRUE) {
    echo "<br>Executed Successfully";
  } else {
    echo "Error: " . $last . "<br>" . $conn->error;
  ...
  $sql = 'INSERT INTO base (Moving) VALUES ("S")';
  if ($conn->query($sql) === TRUE) {
    echo "<br>Executed Successfully";
  } else {
    echo "Error: " . $last . "<br>" . $conn->error;
